...
<!--头部-->
<!--banner-->
<div class="second_banner"><img src="/front/assets/img/1.gif" alt=""></div>
<!--//banner-->
...
<div class="container">
    <div class="left">
        <div class="menu">
            ...
            <ul id="tab">
                <li class="active" onclick="changeValue(this)"><a href="javascript:void(0)">企业概况</a></li>
                <li onclick="changeValue(this)"><a href="javascript:void(0)">企业认证</a></li>
            </ul>
        </div>
    </div>
    <div class="right">
        <div class="location">
            <span>当前位置：<a href="#">企业简介</a></span>
        ...
        <div style="font-size: 14px; margin-top: 53px; line-height: 36px;">
            <div id="tab_con">
                ...
                <div id="tab_con_2" class="dis-n" style="text-align: center;">
                    <img src="/front/img/architecture.png" alt="" style="margin: 2% 0;">
                </div>
            </div>
        </div>
    </div>
